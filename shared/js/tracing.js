(function(global){
  ...
  function ensureTracingRuntimeStyles(){
    if (typeof document === "undefined" || document.getElementById("gpTracingRuntimeStyles")) return;
    const style = document.createElement("style");
    style.id = "gpTracingRuntimeStyles";
    style.textContent =

    ...
    const pairs = [
      { left:{x:0.306,y:0.355}, right:{x:0.676,y:0.355} },
      { left:{x:0.306,y:0.505}, right:{x:0.676,y:0.505} },
      { left:{x:0.307,y:0.668}, right:{x:0.678,y:0.668} },
      { left:{x:0.306,y:0.836}, right:{x:0.679,y:0.836} }
    ];
    ...
    if(prevBtn) prevBtn.addEventListener('click', () => { window.location.href = 'LevelC18.html'; });
    if(nextBtn) nextBtn.addEventListener('click', () => { window.location.href = '../thursday/LevelC_Revision3.html'; });
